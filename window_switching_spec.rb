...
not_compliant_on %i(webdriver iphone), %i(webdriver safari) do
  bug "Most of these tests fail when run in a suite, but pass individually", :marionette do
    describe "Browser" do
      before do
  ...
  describe "Window" do
    ...
    context "manipulating size and position" do
      ...
      compliant_on %i(webdriver firefox window_manager),
                   %i(webdriver marionette window_manager) do
